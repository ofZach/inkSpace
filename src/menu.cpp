...
void menu::setup(){
    ...
    brushImg.loadImage("a.png");
    brushImgInner.loadImage("b.png");
...
void menu::update(){
    if (bMenuOpen){
        ...
        menuOpenPct = 0.97f * menuOpenPct + 0.03f * 0.0;
    }

    mainRectangle.set((-menuFbo->getWidth() + 100) * (1-menuOpenPct),0, menuFbo->getWidth(), menuFbo->getHeight());
...
//        										0,0,1,1);
     ...
     ofSetColor(255);
     menuFbo->draw( (-menuFbo->getWidth() + 250) * (1-menuOpenPct),0);
